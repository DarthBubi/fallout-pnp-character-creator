...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20, 50, 211, 231))
        ...
        self.gridLayout_4.addWidget(self.availablePointsBox, 8, 1, 1, 1)
        self.strengthLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.strengthLabel.setObjectName("strengthLabel")
        self.gridLayout_4.addWidget(self.strengthLabel, 1, 0, 1, 1)
        self.charismaBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.charismaBox.setObjectName("charismaBox")
        self.gridLayout_4.addWidget(self.charismaBox, 4, 1, 1, 1)
        self.strengthBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.strengthBox.setObjectName("strengthBox")
        self.gridLayout_4.addWidget(self.strengthBox, 1, 1, 1, 1)
        self.agilityBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.agilityBox.setObjectName("agilityBox")
        self.gridLayout_4.addWidget(self.agilityBox, 6, 1, 1, 1)
        self.perceptionBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.perceptionBox.setObjectName("perceptionBox")
        self.gridLayout_4.addWidget(self.perceptionBox, 2, 1, 1, 1)
        self.luckLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.luckLabel.setObjectName("luckLabel")
        self.gridLayout_4.addWidget(self.luckLabel, 7, 0, 1, 1)
        self.intelligenceBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.intelligenceBox.setObjectName("intelligenceBox")
        self.gridLayout_4.addWidget(self.intelligenceBox, 5, 1, 1, 1)
        self.label_35 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_35.setObjectName("label_35")
        self.gridLayout_4.addWidget(self.label_35, 8, 0, 1, 1)
        self.charismaLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.charismaLabel.setObjectName("charismaLabel")
        self.gridLayout_4.addWidget(self.charismaLabel, 4, 0, 1, 1)
        self.intelligenceLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.intelligenceLabel.setObjectName("intelligenceLabel")
        self.gridLayout_4.addWidget(self.intelligenceLabel, 5, 0, 1, 1)
        self.perceptionLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.perceptionLabel.setObjectName("perceptionLabel")
        self.gridLayout_4.addWidget(self.perceptionLabel, 2, 0, 1, 1)
        self.enduranceBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.enduranceBox.setObjectName("enduranceBox")
        self.gridLayout_4.addWidget(self.enduranceBox, 3, 1, 1, 1)
        self.strengthModBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.strengthModBox.setReadOnly(True)
        self.strengthModBox.setObjectName("strengthModBox")
        self.gridLayout_4.addWidget(self.strengthModBox, 1, 2, 1, 1)
        self.strengthTotalBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.strengthTotalBox.setReadOnly(True)
        self.strengthTotalBox.setObjectName("strengthTotalBox")
        self.gridLayout_4.addWidget(self.strengthTotalBox, 1, 3, 1, 1)
        self.enduranceTotalBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.enduranceTotalBox.setReadOnly(True)
        self.enduranceTotalBox.setObjectName("enduranceTotalBox")
        self.gridLayout_4.addWidget(self.enduranceTotalBox, 3, 3, 1, 1)
        self.charismaTotalBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.charismaTotalBox.setReadOnly(True)
        self.charismaTotalBox.setObjectName("charismaTotalBox")
        self.gridLayout_4.addWidget(self.charismaTotalBox, 4, 3, 1, 1)
        self.luckTotalBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.luckTotalBox.setReadOnly(True)
        self.luckTotalBox.setObjectName("luckTotalBox")
        self.gridLayout_4.addWidget(self.luckTotalBox, 7, 3, 1, 1)
        self.agilityTotalBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.agilityTotalBox.setReadOnly(True)
        self.agilityTotalBox.setObjectName("agilityTotalBox")
        self.gridLayout_4.addWidget(self.agilityTotalBox, 6, 3, 1, 1)
        self.intelligenceTotalBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.intelligenceTotalBox.setReadOnly(True)
        self.intelligenceTotalBox.setObjectName("intelligenceTotalBox")
        self.gridLayout_4.addWidget(self.intelligenceTotalBox, 5, 3, 1, 1)
        self.perceptionTotalBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.perceptionTotalBox.setReadOnly(True)
        self.perceptionTotalBox.setObjectName("perceptionTotalBox")
        self.gridLayout_4.addWidget(self.perceptionTotalBox, 2, 3, 1, 1)
        self.agilityModBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.agilityModBox.setReadOnly(True)
        self.agilityModBox.setObjectName("agilityModBox")
        self.gridLayout_4.addWidget(self.agilityModBox, 6, 2, 1, 1)
        self.enduranceModBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.enduranceModBox.setReadOnly(True)
        self.enduranceModBox.setObjectName("enduranceModBox")
        self.gridLayout_4.addWidget(self.enduranceModBox, 3, 2, 1, 1)
        self.perceptionModBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.perceptionModBox.setReadOnly(True)
        self.perceptionModBox.setObjectName("perceptionModBox")
        self.gridLayout_4.addWidget(self.perceptionModBox, 2, 2, 1, 1)
        self.luckModBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.luckModBox.setReadOnly(True)
        self.luckModBox.setObjectName("luckModBox")
        self.gridLayout_4.addWidget(self.luckModBox, 7, 2, 1, 1)
        self.intelligenceModBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.intelligenceModBox.setReadOnly(True)
        self.intelligenceModBox.setObjectName("intelligenceModBox")
        self.gridLayout_4.addWidget(self.intelligenceModBox, 5, 2, 1, 1)
        self.charismaModBox = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.charismaModBox.setReadOnly(True)
        self.charismaModBox.setObjectName("charismaModBox")
        self.gridLayout_4.addWidget(self.charismaModBox, 4, 2, 1, 1)
        self.baseValueLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.baseValueLabel.setObjectName("baseValueLabel")
        self.gridLayout_4.addWidget(self.baseValueLabel, 0, 1, 1, 1)
        self.modValueLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.modValueLabel.setObjectName("modValueLabel")
        self.gridLayout_4.addWidget(self.modValueLabel, 0, 2, 1, 1)
        self.totalValueLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.totalValueLabel.setObjectName("totalValueLabel")
        self.gridLayout_4.addWidget(self.totalValueLabel, 0, 3, 1, 1)
        ...
        self.explosivesBox.setReadOnly(True)
        ...
        self.sneakBox.setReadOnly(True)
        ...
        self.meleeWeaponsBox.setReadOnly(True)
        ...
        self.energyWeaponsBox.setReadOnly(True)
        ...
        self.unarmedBox.setReadOnly(True)
        ...
        self.smallGunsBox.setReadOnly(True)
        ...
        self.bigGunsBox.setReadOnly(True)
        ...
        self.trapsBox.setReadOnly(True)
        ...
        self.survivalBox.setReadOnly(True)
        ...
        self.repairBox.setReadOnly(True)
        ...
        self.pilotBox.setReadOnly(True)
        ...
        self.barterBox.setReadOnly(True)
        ...
        self.gamblingBox.setReadOnly(True)
        ...
        self.doctorBox.setReadOnly(True)
        ...
        self.throwingBox.setReadOnly(True)
        ...
        self.scienceBox.setReadOnly(True)
        ...
        self.lockpickBox.setReadOnly(True)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.baseValueLabel.setText(_translate("Dialog", "Base"))
        self.modValueLabel.setText(_translate("Dialog", "Mod"))
        self.totalValueLabel.setText(_translate("Dialog", "Total"))
